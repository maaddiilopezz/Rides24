...
public class CheckComplaintGUI extends JFrame {
	...
	public CheckComplaintGUI(String e)
	{
		email=e;
		
		BLFacade facade = MainGUI.getBusinessLogic();
		
		List<Complaint> comList = facade.getDriverComplaint(email);
		...
		jButtonMoreInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Complaint com = facade.getDriverComplaint(email).get(tableReservations.getSelectedRow());
		...
		jButtonAccept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				comList = facade.getDriverComplaint(email);
		...
		jButtonDeny.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Complaint c = comList.get(tableReservations.getSelectedRow());
				if(c.isDenied()) {
					jLabelError.setText(ResourceBundle.getBundle("Etiquetas").getString("CheckReservationsGUI.jLabelError"));
				}else {
					facade.denyComplaint(c);
				}
			}
		});
